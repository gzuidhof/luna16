...
def check_coordinates(image_coord,candidate):
    ...
    if image_coord[0] > coord_x - 0.5*diameter and image_coord[0] < coord_x + 0.5*diameter and\
       image_coord[1] > coord_y - 0.5*diameter and image_coord[1] < coord_y + 0.5*diameter:
        return True
    return False
...
if __name__ == "__main__":
    ...
    print is_candidate([200,-177],"1.3.6.1.4.1.14519.5.2.1.6279.6001.100225287222365663678666836860")
